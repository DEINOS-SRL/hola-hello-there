  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "collapsible-down": "collapsible-down 0.3s cubic-bezier(0.32, 0.72, 0, 1)",
        "collapsible-up": "collapsible-up 0.25s cubic-bezier(0.32, 0.72, 0, 1)",
        "fade-in": "fade-in 0.5s ease-out",
        "slide-up": "slide-up 0.3s ease-out",
        "slide-in-left": "slide-in-left 0.4s ease-out",
        "slide-in-from-left": "slide-in-from-left 0.3s cubic-bezier(0.32, 0.72, 0, 1)",
        "slide-out-to-left": "slide-out-to-left 0.25s cubic-bezier(0.32, 0.72, 0, 1)",
        "timeline-enter": "timeline-enter 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",
        "pulse-soft": "pulse-soft 2s ease-in-out infinite",
        "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "shake": "shake 0.4s ease-in-out",
        "dialog-in": "dialog-in 0.25s cubic-bezier(0.16, 1, 0.3, 1)",
        "dialog-out": "dialog-out 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
        "dialog-overlay-in": "dialog-overlay-in 0.2s ease-out",
        "dialog-overlay-out": "dialog-overlay-out 0.15s ease-in",
        "dialog-content-show": "dialog-content-show 0.3s cubic-bezier(0.16, 1, 0.3, 1)",
